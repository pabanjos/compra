...
public class BancoServiceLocator extends org.apache.axis.client.Service implements controle.soap.BancoService {
    ...
    private java.lang.String Banco_address = "http://localhost:8080/WebService_SOAP/services/Banco";
    ...
    public controle.soap.Banco getBanco(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            controle.soap.BancoSoapBindingStub _stub = new controle.soap.BancoSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (controle.soap.Banco.class.isAssignableFrom(serviceEndpointInterface)) {
                controle.soap.BancoSoapBindingStub _stub = new controle.soap.BancoSoapBindingStub(new java.net.URL(Banco_address), this);
                _stub.setPortName(getBancoWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap.controle", "BancoService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap.controle", "Banco"));
        }
